...
const ToDoItem = ({ text, id, finished, removeItem, toggleItem }: Props) => {
  return (
    ...
    >
      ...
      >
        <div
          className={`transition-all border border-gray-300 rounded-full mx-2 h-6 min-w-[2rem] sm:w-8 sm:h-8 flex justify-center items-center
        ...
        <p
          className={`relative before:absolute before:top-[55%] before:left-0 before:h-[2px]
                      transition-all duration-200 before:duration-200 text-ellipsis overflow-hidden
                      ${
                        finished
